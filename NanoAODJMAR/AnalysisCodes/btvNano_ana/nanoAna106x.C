#define nanoAna106x_cxx
// The class definition in nanoAna106x.h has been generated automatically
...
//
// root> T->Process("nanoAna106x.C")
// root> T->Process("nanoAna106x.C","some options")
// root> T->Process("nanoAna106x.C+")
//


#include "nanoAna106x.h"
#include <TH2.h>
#include <TStyle.h>

void nanoAna106x::Begin(TTree * /*tree*/)
{
...
void nanoAna106x::SlaveBegin(TTree * /*tree*/)
{
...
bool nanoAna106x::Process(Long64_t entry)
{
...
void nanoAna106x::SlaveTerminate()
{
...
void nanoAna106x::BookHistograms(){
