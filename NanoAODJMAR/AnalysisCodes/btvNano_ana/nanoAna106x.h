...
// Tue Oct  7 12:35:36 2025 by ROOT version 6.36.02
// from TTree Events/Events
// found on file: datasets/nano106X_on_mini106X_2017_mc_NANO.root
//////////////////////////////////////////////////////////

#ifndef nanoAna106x_h
#define nanoAna106x_h
...
class nanoAna106x : public TSelector {
public :
   ...
   TTreeReaderValue<UInt_t> nJetPFCandsAK4 = {fReader, "nJetPFCandsAK4"};
   TTreeReaderArray<Float_t> JetPFCandsAK4_btagEtaRel = {fReader, "JetPFCandsAK4_btagEtaRel"};
   TTreeReaderArray<Float_t> JetPFCandsAK4_btagPtRatio = {fReader, "JetPFCandsAK4_btagPtRatio"};
   TTreeReaderArray<Float_t> JetPFCandsAK4_btagPParRatio = {fReader, "JetPFCandsAK4_btagPParRatio"};
   TTreeReaderArray<Float_t> JetPFCandsAK4_btagSip3dVal = {fReader, "JetPFCandsAK4_btagSip3dVal"};
   TTreeReaderArray<Float_t> JetPFCandsAK4_btagSip3dSig = {fReader, "JetPFCandsAK4_btagSip3dSig"};
   TTreeReaderArray<Float_t> JetPFCandsAK4_btagJetDistVal = {fReader, "JetPFCandsAK4_btagJetDistVal"};
   TTreeReaderArray<Int_t> JetPFCandsAK4_candIdx = {fReader, "JetPFCandsAK4_candIdx"};
   TTreeReaderArray<Int_t> JetPFCandsAK4_jetIdx = {fReader, "JetPFCandsAK4_jetIdx"};
   TTreeReaderValue<UInt_t> nJetSVsAK4 = {fReader, "nJetSVsAK4"};
   TTreeReaderArray<Float_t> JetSVsAK4_mass = {fReader, "JetSVsAK4_mass"};
   TTreeReaderArray<Float_t> JetSVsAK4_pt = {fReader, "JetSVsAK4_pt"};
   TTreeReaderArray<Float_t> JetSVsAK4_ntracks = {fReader, "JetSVsAK4_ntracks"};
   TTreeReaderArray<Float_t> JetSVsAK4_chi2 = {fReader, "JetSVsAK4_chi2"};
   TTreeReaderArray<Float_t> JetSVsAK4_normchi2 = {fReader, "JetSVsAK4_normchi2"};
   TTreeReaderArray<Float_t> JetSVsAK4_dxy = {fReader, "JetSVsAK4_dxy"};
   TTreeReaderArray<Float_t> JetSVsAK4_dxysig = {fReader, "JetSVsAK4_dxysig"};
   TTreeReaderArray<Float_t> JetSVsAK4_d3d = {fReader, "JetSVsAK4_d3d"};
   TTreeReaderArray<Float_t> JetSVsAK4_d3dsig = {fReader, "JetSVsAK4_d3dsig"};
   TTreeReaderArray<Float_t> JetSVsAK4_costhetasvpv = {fReader, "JetSVsAK4_costhetasvpv"};
   TTreeReaderArray<Float_t> JetSVsAK4_phirel = {fReader, "JetSVsAK4_phirel"};
   TTreeReaderArray<Float_t> JetSVsAK4_ptrel = {fReader, "JetSVsAK4_ptrel"};
   TTreeReaderArray<Float_t> JetSVsAK4_deltaR = {fReader, "JetSVsAK4_deltaR"};
   TTreeReaderArray<Float_t> JetSVsAK4_enration = {fReader, "JetSVsAK4_enration"};
   TTreeReaderArray<Int_t> JetSVsAK4_jetIdx = {fReader, "JetSVsAK4_jetIdx"};
   TTreeReaderValue<UInt_t> nJetPFCandsAK8 = {fReader, "nJetPFCandsAK8"};
   TTreeReaderArray<Float_t> JetPFCandsAK8_btagEtaRel = {fReader, "JetPFCandsAK8_btagEtaRel"};
   TTreeReaderArray<Float_t> JetPFCandsAK8_btagPtRatio = {fReader, "JetPFCandsAK8_btagPtRatio"};
   TTreeReaderArray<Float_t> JetPFCandsAK8_btagPParRatio = {fReader, "JetPFCandsAK8_btagPParRatio"};
   TTreeReaderArray<Float_t> JetPFCandsAK8_btagSip3dVal = {fReader, "JetPFCandsAK8_btagSip3dVal"};
   TTreeReaderArray<Float_t> JetPFCandsAK8_btagSip3dSig = {fReader, "JetPFCandsAK8_btagSip3dSig"};
   TTreeReaderArray<Float_t> JetPFCandsAK8_btagJetDistVal = {fReader, "JetPFCandsAK8_btagJetDistVal"};
   TTreeReaderArray<Int_t> JetPFCandsAK8_candIdx = {fReader, "JetPFCandsAK8_candIdx"};
   TTreeReaderArray<Int_t> JetPFCandsAK8_jetIdx = {fReader, "JetPFCandsAK8_jetIdx"};
   TTreeReaderValue<UInt_t> nJetSVsAK8 = {fReader, "nJetSVsAK8"};
   TTreeReaderArray<Float_t> JetSVsAK8_mass = {fReader, "JetSVsAK8_mass"};
   TTreeReaderArray<Float_t> JetSVsAK8_pt = {fReader, "JetSVsAK8_pt"};
   TTreeReaderArray<Float_t> JetSVsAK8_ntracks = {fReader, "JetSVsAK8_ntracks"};
   TTreeReaderArray<Float_t> JetSVsAK8_chi2 = {fReader, "JetSVsAK8_chi2"};
   TTreeReaderArray<Float_t> JetSVsAK8_normchi2 = {fReader, "JetSVsAK8_normchi2"};
   TTreeReaderArray<Float_t> JetSVsAK8_dxy = {fReader, "JetSVsAK8_dxy"};
   TTreeReaderArray<Float_t> JetSVsAK8_dxysig = {fReader, "JetSVsAK8_dxysig"};
   TTreeReaderArray<Float_t> JetSVsAK8_d3d = {fReader, "JetSVsAK8_d3d"};
   TTreeReaderArray<Float_t> JetSVsAK8_d3dsig = {fReader, "JetSVsAK8_d3dsig"};
   TTreeReaderArray<Float_t> JetSVsAK8_costhetasvpv = {fReader, "JetSVsAK8_costhetasvpv"};
   TTreeReaderArray<Float_t> JetSVsAK8_phirel = {fReader, "JetSVsAK8_phirel"};
   TTreeReaderArray<Float_t> JetSVsAK8_ptrel = {fReader, "JetSVsAK8_ptrel"};
   TTreeReaderArray<Float_t> JetSVsAK8_deltaR = {fReader, "JetSVsAK8_deltaR"};
   TTreeReaderArray<Float_t> JetSVsAK8_enration = {fReader, "JetSVsAK8_enration"};
   TTreeReaderArray<Int_t> JetSVsAK8_jetIdx = {fReader, "JetSVsAK8_jetIdx"};
   TTreeReaderValue<UInt_t> nJetPFCands = {fReader, "nJetPFCands"};
   TTreeReaderArray<Float_t> JetPFCands_d0 = {fReader, "JetPFCands_d0"};
   TTreeReaderArray<Float_t> JetPFCands_d0Err = {fReader, "JetPFCands_d0Err"};
   TTreeReaderArray<Float_t> JetPFCands_dz = {fReader, "JetPFCands_dz"};
   TTreeReaderArray<Float_t> JetPFCands_dzErr = {fReader, "JetPFCands_dzErr"};
   TTreeReaderArray<Float_t> JetPFCands_eta = {fReader, "JetPFCands_eta"};
   TTreeReaderArray<Float_t> JetPFCands_mass = {fReader, "JetPFCands_mass"};
   TTreeReaderArray<Float_t> JetPFCands_phi = {fReader, "JetPFCands_phi"};
   TTreeReaderArray<Float_t> JetPFCands_pt = {fReader, "JetPFCands_pt"};
   TTreeReaderArray<Float_t> JetPFCands_puppiWeight = {fReader, "JetPFCands_puppiWeight"};
   TTreeReaderArray<Float_t> JetPFCands_puppiWeightNoLep = {fReader, "JetPFCands_puppiWeightNoLep"};
   TTreeReaderArray<Float_t> JetPFCands_trkChi2 = {fReader, "JetPFCands_trkChi2"};
   TTreeReaderArray<Float_t> JetPFCands_vtxChi2 = {fReader, "JetPFCands_vtxChi2"};
   TTreeReaderArray<Int_t> JetPFCands_charge = {fReader, "JetPFCands_charge"};
   TTreeReaderArray<Int_t> JetPFCands_lostInnerHits = {fReader, "JetPFCands_lostInnerHits"};
   TTreeReaderArray<Int_t> JetPFCands_pdgId = {fReader, "JetPFCands_pdgId"};
   TTreeReaderArray<Int_t> JetPFCands_pvAssocQuality = {fReader, "JetPFCands_pvAssocQuality"};
   TTreeReaderArray<Int_t> JetPFCands_trkQuality = {fReader, "JetPFCands_trkQuality"};
   ...
   TTreeReaderValue<UInt_t> nGenJetCandsAK4 = {fReader, "nGenJetCandsAK4"};
   TTreeReaderArray<Int_t> GenJetCandsAK4_candIdx = {fReader, "GenJetCandsAK4_candIdx"};
   TTreeReaderArray<Int_t> GenJetCandsAK4_jetIdx = {fReader, "GenJetCandsAK4_jetIdx"};
   TTreeReaderValue<UInt_t> nGenJetSVsAK4 = {fReader, "nGenJetSVsAK4"};
   TTreeReaderArray<Int_t> GenJetSVsAK4_jetIdx = {fReader, "GenJetSVsAK4_jetIdx"};
   TTreeReaderValue<UInt_t> nGenJetCandsAK8 = {fReader, "nGenJetCandsAK8"};
   TTreeReaderArray<Int_t> GenJetCandsAK8_candIdx = {fReader, "GenJetCandsAK8_candIdx"};
   TTreeReaderArray<Int_t> GenJetCandsAK8_jetIdx = {fReader, "GenJetCandsAK8_jetIdx"};
   TTreeReaderValue<UInt_t> nGenJetSVsAK8 = {fReader, "nGenJetSVsAK8"};
   TTreeReaderArray<Int_t> GenJetSVsAK8_jetIdx = {fReader, "GenJetSVsAK8_jetIdx"};
   ...
   TTreeReaderValue<UInt_t> nGenJetCands = {fReader, "nGenJetCands"};
   TTreeReaderArray<Float_t> GenJetCands_eta = {fReader, "GenJetCands_eta"};
   TTreeReaderArray<Float_t> GenJetCands_mass = {fReader, "GenJetCands_mass"};
   TTreeReaderArray<Float_t> GenJetCands_phi = {fReader, "GenJetCands_phi"};
   TTreeReaderArray<Float_t> GenJetCands_pt = {fReader, "GenJetCands_pt"};
   TTreeReaderArray<Int_t> GenJetCands_charge = {fReader, "GenJetCands_charge"};
   TTreeReaderArray<Int_t> GenJetCands_pdgId = {fReader, "GenJetCands_pdgId"};
   ...
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_flightDistance2dSig = {fReader, "FatJet_DDX_tau1_flightDistance2dSig"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_trackEtaRel_0 = {fReader, "FatJet_DDX_tau1_trackEtaRel_0"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_trackEtaRel_1 = {fReader, "FatJet_DDX_tau1_trackEtaRel_1"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_trackEtaRel_2 = {fReader, "FatJet_DDX_tau1_trackEtaRel_2"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_trackSip3dSig_0 = {fReader, "FatJet_DDX_tau1_trackSip3dSig_0"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_trackSip3dSig_1 = {fReader, "FatJet_DDX_tau1_trackSip3dSig_1"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_vertexDeltaR = {fReader, "FatJet_DDX_tau1_vertexDeltaR"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_vertexEnergyRatio = {fReader, "FatJet_DDX_tau1_vertexEnergyRatio"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau1_vertexMass = {fReader, "FatJet_DDX_tau1_vertexMass"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_flightDistance2dSig = {fReader, "FatJet_DDX_tau2_flightDistance2dSig"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_trackEtaRel_0 = {fReader, "FatJet_DDX_tau2_trackEtaRel_0"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_trackEtaRel_1 = {fReader, "FatJet_DDX_tau2_trackEtaRel_1"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_trackEtaRel_3 = {fReader, "FatJet_DDX_tau2_trackEtaRel_3"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_trackSip3dSig_0 = {fReader, "FatJet_DDX_tau2_trackSip3dSig_0"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_trackSip3dSig_1 = {fReader, "FatJet_DDX_tau2_trackSip3dSig_1"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_vertexEnergyRatio = {fReader, "FatJet_DDX_tau2_vertexEnergyRatio"};
   TTreeReaderArray<Float_t> FatJet_DDX_tau2_vertexMass = {fReader, "FatJet_DDX_tau2_vertexMass"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip2dSigAboveBottom_0 = {fReader, "FatJet_DDX_trackSip2dSigAboveBottom_0"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip2dSigAboveBottom_1 = {fReader, "FatJet_DDX_trackSip2dSigAboveBottom_1"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip2dSigAboveCharm = {fReader, "FatJet_DDX_trackSip2dSigAboveCharm"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip3dSig_0 = {fReader, "FatJet_DDX_trackSip3dSig_0"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip3dSig_1 = {fReader, "FatJet_DDX_trackSip3dSig_1"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip3dSig_2 = {fReader, "FatJet_DDX_trackSip3dSig_2"};
   TTreeReaderArray<Float_t> FatJet_DDX_trackSip3dSig_3 = {fReader, "FatJet_DDX_trackSip3dSig_3"};
   TTreeReaderArray<Float_t> FatJet_DDX_z_ratio = {fReader, "FatJet_DDX_z_ratio"};
   TTreeReaderArray<Float_t> FatJet_Proba = {fReader, "FatJet_Proba"};
   TTreeReaderArray<Float_t> FatJet_btagDeepB_b = {fReader, "FatJet_btagDeepB_b"};
   TTreeReaderArray<Float_t> FatJet_btagDeepB_bb = {fReader, "FatJet_btagDeepB_bb"};
   TTreeReaderArray<Float_t> FatJet_btagDeepL = {fReader, "FatJet_btagDeepL"};
   TTreeReaderArray<Int_t> FatJet_DDX_jetNSecondaryVertices = {fReader, "FatJet_DDX_jetNSecondaryVertices"};
   TTreeReaderArray<Int_t> FatJet_DDX_jetNTracks = {fReader, "FatJet_DDX_jetNTracks"};
   TTreeReaderArray<Int_t> FatJet_nBHadrons = {fReader, "FatJet_nBHadrons"};
   TTreeReaderArray<Int_t> FatJet_nCHadrons = {fReader, "FatJet_nCHadrons"};
   TTreeReaderArray<Float_t> Jet_Proba = {fReader, "Jet_Proba"};
   TTreeReaderArray<Float_t> Jet_btagDeepB_b = {fReader, "Jet_btagDeepB_b"};
   TTreeReaderArray<Float_t> Jet_btagDeepB_bb = {fReader, "Jet_btagDeepB_bb"};
   TTreeReaderArray<Float_t> Jet_btagDeepL = {fReader, "Jet_btagDeepL"};
   TTreeReaderArray<Int_t> Jet_nBHadrons = {fReader, "Jet_nBHadrons"};
   TTreeReaderArray<Int_t> Jet_nCHadrons = {fReader, "Jet_nCHadrons"};
   TTreeReaderArray<Float_t> SubJet_Proba = {fReader, "SubJet_Proba"};
   TTreeReaderArray<Float_t> SubJet_btagDeepB_b = {fReader, "SubJet_btagDeepB_b"};
   TTreeReaderArray<Float_t> SubJet_btagDeepB_bb = {fReader, "SubJet_btagDeepB_bb"};
   TTreeReaderArray<Float_t> SubJet_btagDeepC = {fReader, "SubJet_btagDeepC"};
   TTreeReaderArray<Float_t> SubJet_btagDeepL = {fReader, "SubJet_btagDeepL"};
   TTreeReaderArray<Int_t> SubJet_nBHadrons = {fReader, "SubJet_nBHadrons"};
   TTreeReaderArray<Int_t> SubJet_nCHadrons = {fReader, "SubJet_nCHadrons"};
   TTreeReaderArray<Int_t> SubJet_subGenJetAK8Idx = {fReader, "SubJet_subGenJetAK8Idx"};
   ...
   nanoAna106x(TTree * /*tree*/ =0) { }
   ~nanoAna106x() override { }
  ...
  struct JetsAK4_PFNano{
   TLorentzVector v;
   float JetPFCandsAK4_btagEtaRel;
   float JetPFCandsAK4_btagPtRel;
   float JetPFCandsAK4_candIdx;
   float JetPFCandsAK4_jetIdx;
   float JetPFCandsAK4_btagSip3dSig;
   float JetPFCandsAK4_btagSip3dVal;
   float JetPFCandsAK4_btagPtRatio;
   float JetPFCandsAK4_btagJetDistVal;
   float JetPFCandsAK4_btagPParRatio;
  };
...
private:
  ...
  time_t start, end;
   ...
   ClassDefOverride(nanoAna106x,0);

};

#endif

#ifdef nanoAna106x_cxx
void nanoAna106x::Init(TTree *tree)
{
