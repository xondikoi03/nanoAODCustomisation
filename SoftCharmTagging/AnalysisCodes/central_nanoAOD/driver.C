...
void driver(int sample=0)
{
  ...
  nanoAna3 m_selec;//declared an instance of our class.
  ...
  if(sample==0){
    chain->Add("../../output_files/testCentral2016nanoAOD.root");
    hstfilename = "../Histograms/nanoAnaCentral2016_hist.root";
  }
