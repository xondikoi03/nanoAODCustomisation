...
# with command line options: NANO --python_filename softCharmTaggingNano_v2_2016ULpreVFP_MC_cfg.py --fileout file:tree.root -s NANO --mc --conditions 106X_mcRun2_asymptotic_preVFP_v11 --era Run2_2016,run2_nanoAOD_106Xv2 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise NanoAODCustomisation/SoftCharmTagging/Customisers.patchVertexTable --customise_commands=process.add_(cms.Service('InitRootHandlers',     EnableIMT = cms.untracked.bool(False)));     process.MessageLogger.cerr.FwkReport.reportEvery=1000;     process.NANOAODSIMoutput.fakeNameForCrab=cms.untracked.bool(True);     from NanoAODCustomisation.SoftCharmTagging.Customisers import reclusterJets;     reclusterJets(process, runOnMC=True) --nThreads 2 -n -1 --no_exec
