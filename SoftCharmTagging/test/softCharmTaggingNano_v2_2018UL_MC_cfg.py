...
# with command line options: NANO --python_filename softCharmTaggingNano_v2_2018UL_MC_cfg.py --fileout file:tree.root -s NANO --mc --conditions 106X_upgrade2018_realistic_v16_L1v1 --era Run2_2018,run2_nanoAOD_106Xv2 --eventcontent NANOAODSIM --datatier NANOAODSIM --customise NanoAODCustomisation/SoftCharmTagging/Customisers.patchVertexTable --customise_commands=process.add_(cms.Service('InitRootHandlers',     EnableIMT = cms.untracked.bool(False)));     process.MessageLogger.cerr.FwkReport.reportEvery=1000;     process.NANOAODSIMoutput.fakeNameForCrab=cms.untracked.bool(True);     from NanoAODCustomisation.SoftCharmTagging.Customisers import reclusterJets;     reclusterJets(process, runOnMC=True) --nThreads 2 -n -1 --no_exec
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string("../output_files/test.root"),
